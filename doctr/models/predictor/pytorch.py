...
__all__ = ["OCRPredictor", "PreprocessAndOCR"]
...
class PreprocessAndOCR(nn.Module, _OCRPredictor):
    """Implements an object able to localize and identify text elements in a set of documents
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        nn.Module.__init__(self)
        self.den_predictor = den_predictor.eval()  # type: ignore[attr-defined]
        self.det_predictor = det_predictor.eval()  # type: ignore[attr-defined]
        self.reco_predictor = reco_predictor.eval()  # type: ignore[attr-defined]
        _OCRPredictor.__init__(
            self, assume_straight_pages, straighten_pages, preserve_aspect_ratio, symmetric_pad, **kwargs
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        # Denoise text elements
        pages = self.den_predictor(pages, **kwargs)
